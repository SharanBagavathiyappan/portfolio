...
const Contact = () => {
  return (
    <>
      ...
      <div className='w-[75%] h-[70vh]  flex flex-wrap items-center justify-evenly gap-5  max-md:h-[80vh] '>
      ...
      max-md:h-[70vh] '>
          ...
          <div className='w-full text-[20px] flex items-center justify-center font-bold mb-[10px] max-md:text-center'>Message me</div>
         <form >
         ...
         <div className='w-[150px] h-[60px]  mt-[50px] rounded-[5px] text-[18px] font-semibold flex items-center justify-center bg-fuchsia-600 text-white
